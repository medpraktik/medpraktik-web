...
Repo ini belum mengaktifkan alur pembayaran digital atau integrasi Supabase. Supabase direncanakan untuk tahap berikutnya: order/request, payment status, license request, fingerprint device, audit aktivasi, dan backoffice ringan.
